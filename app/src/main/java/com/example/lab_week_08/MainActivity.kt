...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Jalankan berurutan (1 dan 2)
        workManager.beginWith(firstRequest)
            .then(secondRequest)
            .then(thirdRequest)
            .enqueue()

        // Observasi FirstWorker
        ...
        // Observasi SecondWorker + notifikasi pertama
        ...
        // Observasi ThirdWorker + notifikasi kedua
    ...
    private fun launchSecondNotificationService() {
        SecondNotificationService.trackingCompletion.observe(this) { Id ->
            showResult("Second notification process for ID $Id is done!")
        }
